...
<simconf version="2023090101">
  <simulation>
    <title>TSCH_UDP_with_data</title>
    ...
    <motetype>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="36.93545777817672" y="20.864998703893377" />
        </interface_config>
        <interface_config>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="29.330850263681896" y="80.72295980360931" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>2</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="2.0955784029391245" y="75.66804807418698" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>3</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="24.584485420982016" y="42.30272244385598" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>4</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="86.25753968876506" y="15.063976119155498" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>5</id>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="39.73949159375566" y="2.611414364853304" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>6</id>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.7964411945428562 0.0 0.0 2.7964411945428562 94.07396156213548 70.86905046582044</viewport>
    </plugin_config>
  ...
  <plugin>
    ...
    <bounds x="400" y="160" height="369" width="1199" z="1" />
  </plugin>
  <plugin>
    ...
    <bounds x="0" y="996" height="166" width="1599" z="5" />
  </plugin>
  <plugin>
    ...
    <bounds x="400" y="0" height="160" width="1199" z="3" />
  </plugin>
  <plugin>
    ...
    <bounds x="34" y="537" height="300" width="500" z="2" />
  </plugin>
  <plugin>
...
//log.testFailed(); /* Report test failure and quit */</script>
    ...
    <bounds x="507" y="81" height="700" width="600" z="-1" minimized="true" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.ScriptRunner
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/simple.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <bounds x="376" y="454" height="700" width="600" />
  </plugin>
</simconf>
